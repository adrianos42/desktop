...
/// Parent data used by [DesktopRenderTable] for its children.
class _TableCellParentData extends BoxParentData {
...
/// Base class to describe how wide a column in a [DesktopRenderTable] should be.
///
...
/// table's container.
@immutable
abstract class _TableColumnWidth {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const _TableColumnWidth();
...
/// Vertical alignment options for cells in [DesktopRenderTable] objects.
///
/// This is specified using [TableCellParentData] objects on the
/// [RenderObject.parentData] of the children of the [DesktopRenderTable].
enum _TableCellVerticalAlignment {
  ...
  /// used is specified by [DesktopRenderTable.textBaseline]. It is not valid to use
  /// the baseline value if [DesktopRenderTable.textBaseline] is not specified.
  ///
...
class DesktopRenderTable extends RenderBox {
