...
class Icons {
  ...
  /// The `accessibility` material icon.
  ...
  /// The `announcement` material icon.
  ...
  /// The `architecture` material icon.
  ...
  /// The `cameraswitch` material icon.
  ...
  /// The `construction` material icon.
  ...
  /// The `notifications` material icon.
  ...
  /// The `skateboarding` material icon.
  ...
  /// The `snowboarding` material icon.
  ...
  /// The `subscriptions` material icon.
