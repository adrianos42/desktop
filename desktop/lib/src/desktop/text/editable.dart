...
///
/// Used by [DesktopRenderEditable.onCaretChanged].
typedef CaretChangedHandler = void Function(Rect caretRect);

/// Represents the coordinates of the point in a selection, and the text
/// direction at that point, relative to top left of the [DesktopRenderEditable] that
/// holds the selection.
@immutable
class TextSelectionPoint {
  ...
  /// relative to the top left of the [DesktopRenderEditable] object.
  final Offset point;
...
class DesktopRenderEditable extends RenderBox with RelayoutWhenSystemFontsChangeMixin, ContainerRenderObjectMixin<RenderBox, TextParentData>, RenderBoxContainerDefaultsMixin<RenderBox, TextParentData> {
  ...
  /// [DesktopRenderEditable]'s text content.
  ///
  ...
  void _handleSelectionChange(
    ...
    // TODO(as): onSelectionChanged?.call(nextSelection, this, cause);
  }
  ...
  ///
  /// [DesktopRenderEditable] is responsible for calculating the [Offset] of this
  ...
  ///
  /// Since [DesktopRenderEditable] does not handle selection manipulation
...
class _RenderEditableCustomPaint extends RenderBox {
  ...
  @override
  DesktopRenderEditable? get parent => super.parent as DesktopRenderEditable?;
  ...
  @override
  void paint(PaintingContext context, Offset offset) {
    final DesktopRenderEditable? parent = this.parent;
    assert(parent != null);
...
/// An interface that paints within a [DesktopRenderEditable]'s bounds, above or
...
/// blocks). It can paint independently from its [DesktopRenderEditable], allowing it
/// to repaint without triggering a repaint on the entire [DesktopRenderEditable] stack
/// when only auxiliary content changes (e.g. a blinking cursor) are present. It
/// will be scheduled to repaint when:
///
///  * It's assigned to a new [DesktopRenderEditable] and the [shouldRepaint] method
///    returns true.
///  * Any of the [DesktopRenderEditable]s it is attached to repaints.
///  * The [notifyListeners] method is called, which typically happens when the
///    painter's attributes change.
///
/// See also:
///
///  * [DesktopRenderEditable.foregroundPainter], which takes a [RenderEditablePainter]
///    and sets it as the foreground painter of the [RenderEditable].
///  * [DesktopRenderEditable.painter], which takes a [RenderEditablePainter]
...
abstract class RenderEditablePainter extends ChangeNotifier {
  ...
  /// is provided to a [DesktopRenderEditable].
  ///
  ...
  /// [DesktopRenderEditable]s it attaches to repaint, even if [shouldRepaint] returns
  /// false.
  bool shouldRepaint(RenderEditablePainter? oldDelegate);

  /// Paints within the bounds of a [DesktopRenderEditable].
  ///
  /// The given [Canvas] has the same coordinate space as the [DesktopRenderEditable],
  /// which may be different from the coordinate space the [DesktopRenderEditable]'s
  /// [TextPainter] uses, when the text moves inside the [DesktopRenderEditable].
  ///
  /// Paint operations performed outside of the region defined by the [canvas]'s
  /// origin and the [size] parameter may get clipped, when [DesktopRenderEditable]'s
  /// [DesktopRenderEditable.clipBehavior] is not [Clip.none].
  void paint(Canvas canvas, Size size, DesktopRenderEditable renderEditable);
}
...
class _FloatingCursorPainter extends RenderEditablePainter {
  ...
  void paintRegularCursor(Canvas canvas, DesktopRenderEditable renderEditable, Color caretColor, TextPosition textPosition) {
