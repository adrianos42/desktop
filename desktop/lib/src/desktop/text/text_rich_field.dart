...
// typedef _SelectionChangedCallback = void Function(
//     TextSelection selection, SelectionChangedCause? cause);

// /// Signature for the callback that reports the app private command results.
// typedef _AppPrivateCommandCallback = void Function(
...
// /// [_TextEditingController], the text field updates [value] and the controller
...
// ///
// /// A [_TextEditingController] can also be used to provide an initial value for a
...
// ///
// /// Remember to [dispose] of the [_TextEditingController] when it is no longer
// /// needed. This will ensure we discard any resources used by the object.
// /// {@tool dartpad}
// /// This example creates a [TextField] with a [_TextEditingController] whose
...
// ///  * [TextRichField], which is a raw region of editable text that can be
// ///    controlled with a [TextEditingController].
// ///  * Learn how to use a [_TextEditingController] in one of our [cookbook recipes](https://flutter.dev/docs/cookbook/forms/text-field-changes#2-use-a-texteditingcontroller).
// class _TextEditingController extends ValueNotifier<TextEditingValue> {
//   /// Creates a controller for an editable text field.
//   ///
//   /// This constructor treats a null [text] argument as if it were the empty
//   /// string.
//   _TextEditingController({String? text})
//       : super(text == null
...
//   /// [TextEditingValue.empty].
//   _TextEditingController.fromValue(TextEditingValue? value)
//       : assert(
//           value == null ||
...
//   /// Setting this will notify all the listeners of this [_TextEditingController]
//   /// that they need to update (it calls [notifyListeners]). For this reason,
//   /// this value should only be set between frames, e.g. in response to user
//   /// actions, not during the build, layout, or paint phases.
//   ///
//   /// This property can be set from a listener added to this
//   /// [_TextEditingController]; however, one should not also set [selection]
...
//   ///
//   /// This property can be set from a listener added to this
//   /// [_TextEditingController]; however, one should not also set [text]
//   /// in a separate statement. To change both the [text] and the [selection]
//   /// change the controller's [value].
//   ///
...
//   ///
//   /// Calling this will notify all the listeners of this [_TextEditingController]
//   /// that they need to update (it calls [notifyListeners]). For this reason,
...
// /// Toolbar configuration for [TextRichField].
// ///
// /// Toolbar is a context menu that will show up when user right click or long
// /// press the [TextRichField]. It includes several options: cut, copy, paste,
// /// and select all.
// ///
// /// [TextRichField] and its derived widgets have their own default [_ToolbarOptions].
// /// Create a custom [_ToolbarOptions] if you want explicit control over the toolbar
// /// option.
// class _ToolbarOptions {
...
//   ///
//   /// If [TextRichField.readOnly] is set to true, cut will be disabled regardless.
//   ///
//   /// Defaults to false. Must not be null.
//   final bool cut;
...
//   ///
//   /// If [TextRichField.readOnly] is set to true, paste will be disabled regardless.
//   ///
//   /// Defaults to false. Must not be null.
//   final bool paste;
...
// ///
// /// * The [controller]'s [_TextEditingController.value] will be updated with the
...
// /// | [ReplaceTextIntent]                     | Replaces the current [TextEditingValue] in the input field's [_TextEditingController], and triggers all related user callbacks and [TextInputFormatter]s. |
// /// | [UpdateSelectionIntent]                 | Updates the current selection in the input field's [_TextEditingController], and triggers the [onSelectionChanged] callback. |
...
// class TextRichField extends StatefulWidget {
...
//   final _TextEditingController controller;
...
//   final _ToolbarOptions toolbarOptions;
...
//   ///
//   /// The cursor refers to the blinking caret when the [TextRichField] is focused.
//   /// {@endtemplate}
//   ///
//   /// See also:
//   ///
...
//   /// [CupertinoTextField], and [TextRichField].
//   ///
...
//   ///
//   /// The [TextRichField] widget used on its own will not trigger the display
//   /// of the selection toolbar by itself. The toolbar is shown by calling
//   /// [_TextRichFieldState.showToolbar] in response to an appropriate user event.
//   ///
//   /// See also:
//   ///
//   ///  * [CupertinoTextField], which wraps an [TextRichField] and which shows the
//   ///    selection toolbar upon user events that are appropriate on the iOS
//   ///    platform.
//   ///  * [TextField], a Material Design themed wrapper of [TextRichField], which
...
//   /// {@endtemplate}
//   final _AppPrivateCommandCallback? onAppPrivateCommand;

//   /// {@template flutter.widgets.editableText.onSelectionChanged}
//   /// Called when the user changes the selection of text (including the cursor
//   /// location).
//   /// {@endtemplate}
//   final _SelectionChangedCallback? onSelectionChanged;
...
//   ///
//   /// The [mouseCursor] is the only property of [TextRichField] that controls the
...
//   ///
//   /// When null, this widget's [_TextRichFieldState] will be used as the
...
//   /// [TextRichField].
//   ///
//   /// If a restoration id is provided, the [TextRichField] will persist its
//   /// current scroll offset and restore it during state restoration.
//   ///
//   /// The scroll offset is persisted in a [RestorationBucket] claimed from
//   /// the surrounding [RestorationScope] using the provided restoration ID.
//   ///
//   /// Persisting and restoring the content of the [TextRichField] is the
...
//   @override
//   _TextRichFieldState createState() => _TextRichFieldState();

//   @override
//   void debugFillProperties(DiagnosticPropertiesBuilder properties) {
//     super.debugFillProperties(properties);
//     properties.add(
//         DiagnosticsProperty<_TextEditingController>('controller', controller));
...
// /// State for a [TextRichField].
// class _TextRichFieldState extends State<TextRichField>
//     with
//         AutomaticKeepAliveClientMixin<TextRichField>,
//         WidgetsBindingObserver,
//         TickerProviderStateMixin<TextRichField>,
...
//   @override
//   void didUpdateWidget(TextRichField oldWidget) {
...
//   /// update via [updateEditingValue], or when [TextRichField] calls
...
//   ///
//   /// Throws an error in debug mode if this [TextRichField] is not in a batch
//   /// edit.
//   void endBatchEdit() {
//     _batchEditDepth -= 1;
//     assert(
...
//     assert(!TextRichField.debugDeterministicCursor);
//     _cursorTimer?.cancel();
...
//     if (TextRichField.debugDeterministicCursor) return;
//     if (widget.cursorOpacityAnimates) {
//       _cursorTimer =
...
//                         showCursor: TextRichField.debugDeterministicCursor
...
//   final _TextRichFieldState state;
...
//   /// The [_TextEditingController] to save the state of over time.
//   final _TextEditingController controller;
...
//   /// than undo/redo.
//   final _TextEditingValueCallback onTriggered;
