...
typedef DesktopSelectionChangedCallback = void Function(TextSelection selection, SelectionChangedCause? cause);

/// Signature for the callback that reports the app private command results.
typedef DesktopAppPrivateCommandCallback = void Function(String, Map<String, dynamic>);
...
/// [DesktopTextEditingController], the text field updates [value] and the controller
...
///
/// A [DesktopTextEditingController] can also be used to provide an initial value for a
...
///
/// Remember to [dispose] of the [DesktopTextEditingController] when it is no longer
/// needed. This will ensure we discard any resources used by the object.
/// {@tool dartpad --template=stateful_widget_material}
/// This example creates a [TextField] with a [DesktopTextEditingController] whose
...
///  * [DesktopEditableText], which is a raw region of editable text that can be
///    controlled with a [TextEditingController].
///  * Learn how to use a [DesktopTextEditingController] in one of our [cookbook recipes](https://flutter.dev/docs/cookbook/forms/text-field-changes#2-use-a-texteditingcontroller).
class DesktopTextEditingController extends ValueNotifier<TextEditingValue> {
  ...
  /// Setting this will notify all the listeners of this [DesktopTextEditingController]
  /// that they need to update (it calls [notifyListeners]). For this reason,
  /// this value should only be set between frames, e.g. in response to user
  /// actions, not during the build, layout, or paint phases.
  ///
  /// This property can be set from a listener added to this
  /// [DesktopTextEditingController]; however, one should not also set [selection]
  ...
  ///
  /// This property can be set from a listener added to this
  /// [DesktopTextEditingController]; however, one should not also set [text]
  /// in a separate statement. To change both the [text] and the [selection]
  /// change the controller's [value].
  ///
  ...
  ///
  /// Calling this will notify all the listeners of this [DesktopTextEditingController]
  /// that they need to update (it calls [notifyListeners]). For this reason,
...
/// Toolbar configuration for [DesktopEditableText].
///
/// Toolbar is a context menu that will show up when user right click or long
/// press the [DesktopEditableText]. It includes several options: cut, copy, paste,
/// and select all.
///
/// [DesktopEditableText] and its derived widgets have their own default [DesktopToolbarOptions].
/// Create a custom [DesktopToolbarOptions] if you want explicit control over the toolbar
/// option.
class DesktopToolbarOptions {
  ...
  ///
  /// If [DesktopEditableText.readOnly] is set to true, cut will be disabled regardless.
  ///
  /// Defaults to false. Must not be null.
  final bool cut;
  ...
  ///
  /// If [DesktopEditableText.readOnly] is set to true, paste will be disabled regardless.
  ///
  /// Defaults to false. Must not be null.
  final bool paste;
...
///
/// * The [controller]'s [DesktopTextEditingController.value] will be updated with the
...
class DesktopEditableText extends StatefulWidget {
  ...
  DesktopEditableText({
    ...
    this.toolbarOptions = const DesktopToolbarOptions(
      copy: true,
      cut: true,
      paste: true,
      selectAll: true,
  ...
  final DesktopToolbarOptions toolbarOptions;
  ...
  ///
  /// The cursor refers to the blinking caret when the [DesktopEditableText] is focused.
  /// {@endtemplate}
  ///
  /// See also:
  ///
  ...
  ///
  /// The [DesktopEditableText] widget used on its own will not trigger the display
  /// of the selection toolbar by itself. The toolbar is shown by calling
  /// [DesktopEditableTextState.showToolbar] in response to an appropriate user event.
  ///
  /// See also:
  ///
  ///  * [CupertinoTextField], which wraps an [DesktopEditableText] and which shows the
  ///    selection toolbar upon user events that are appropriate on the iOS
  ///    platform.
  ///  * [TextField], a Material Design themed wrapper of [DesktopEditableText], which
  ...
  /// [DesktopTextEditingController.addListener].
  ///
  /// {@tool dartpad --template=stateful_widget_material}
  ///
  ...
  /// {@endtemplate}
  final DesktopAppPrivateCommandCallback? onAppPrivateCommand;

  /// {@template flutter.widgets.editableText.onSelectionChanged}
  /// Called when the user changes the selection of text (including the cursor
  /// location).
  /// {@endtemplate}
  final DesktopSelectionChangedCallback? onSelectionChanged;
  ...
  ///
  /// The [mouseCursor] is the only property of [DesktopEditableText] that controls the
  ...
  /// [DesktopEditableText].
  ///
  /// If a restoration id is provided, the [DesktopEditableText] will persist its
  /// current scroll offset and restore it during state restoration.
  ///
  /// The scroll offset is persisted in a [RestorationBucket] claimed from
  /// the surrounding [RestorationScope] using the provided restoration ID.
  ///
  /// Persisting and restoring the content of the [DesktopEditableText] is the
...
/// State for a [DesktopEditableText].
class DesktopEditableTextState extends State<DesktopEditableText> with AutomaticKeepAliveClientMixin<DesktopEditableText>, WidgetsBindingObserver, TickerProviderStateMixin<DesktopEditableText>, TextSelectionDelegate implements TextInputClient, AutofillClient, TextEditingActionTarget {
  Timer? _cursorTimer;
  ...
  /// update via [updateEditingValue], or when [DesktopEditableText] calls
  ...
  ///
  /// Throws an error in debug mode if this [DesktopEditableText] is not in a batch
  /// edit.
  void endBatchEdit() {
    _batchEditDepth -= 1;
    assert(
  ...
  void _cursorWaitForStart(Timer timer) {
    ...
    assert(!DesktopEditableText.debugDeterministicCursor);
    _cursorTimer?.cancel();
  ...
  void _startCursorTimer() {
    ...
    if (DesktopEditableText.debugDeterministicCursor)
      return;
    if (widget.cursorOpacityAnimates) {
